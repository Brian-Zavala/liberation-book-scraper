...
class BatchOperations:
    ...
    def scrape_multiple_authors(self, authors: List[str], 
    ...
    def generate_reading_list(self, subjects: List[str] = None, 
                            min_year: int = None,
...
if __name__ == "__main__":
    ...
    multi.add_argument('-s', '--source', choices=['gutenberg', 'archive'], 
                      default='gutenberg')
    ...
    file_cmd.add_argument('-s', '--source', choices=['gutenberg', 'archive'],
                         default='gutenberg')
